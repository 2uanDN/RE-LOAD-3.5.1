...
function semanticChunk(text, maxTokens = CHUNK_TARGET_TOKENS) {
  ...
  while (startIndex < items.length) {
    ...
    // Calculate next startIndex to ensure ~20% overlap
    const overlapTargetTokens = Math.floor(maxTokens * 0.2);
    let overlapTokens = 0;
